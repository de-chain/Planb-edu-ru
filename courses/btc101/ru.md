...
В этих 25 главах нашего курса мы простым и эффективным способом объясним основы Bitcoin. 
Этот курс охватывает основы протокол bitcoin в целом, включая такие темы, как mining, wallet, exchange и другие ключевые аспекты.
